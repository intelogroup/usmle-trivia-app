    ...
    >
      <div className="flex items-start justify-between mb-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-semibold text-gray-800 dark:text-dark-50 text-sm">
              {title}
            </h3>
        ...
        <ChevronRight
          size={16}
          className="text-gray-400 dark:text-dark-400 mt-0.5"
        />
      </div>

      <p className="text-xs text-gray-600 dark:text-dark-300 mb-3 leading-relaxed">
        {description}
      </p>
      ...
      <div className="flex items-center justify-between">
        ...
        <span className="text-xs font-bold text-gray-700 dark:text-dark-200">
          {progress}%
        </span>
      </div>
    </motion.button>
